...
/**/) {
'use strict';var $utils=template.utils,$helpers=$utils.$helpers,$escape=$utils.$escape,name=$data.name,$out='';$out+='<div>\r\ni am ';
$out+=$escape(name);
$out+=' tpl\r\n</div>';
...
var profileTpl = __webpack_require__(2);
var html1 = profileTpl({ name: 'profile' });

var profileTpl2 = __webpack_require__(3);
